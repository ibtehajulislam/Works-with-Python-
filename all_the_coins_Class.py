...
class Coin:
    def __init__(self,clean = True, heads = True, rare = False,**kwargs):
...
#Adding extra value of 25% extra if this is a rare coin
        if self.is_rare: 
...
# Defining different methods of the coin class
    def rust(self):
        self.color = self.rusty_color
...
for coin in coins:
    ...
    string = "{}- Color: {}, Value: {}, Diameter(mm): {}, Thickness(m): {}, Number of Edges: {}, Mass(g): {}".format(*arguments)
    print(string)
